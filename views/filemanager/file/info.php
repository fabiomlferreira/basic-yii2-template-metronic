...
/* @var $model fabiomlferreira\filemanager\models\Mediafile */
...
<?php $form = ActiveForm::begin([
    ...
    'options' => ['id' => 'control-form', 'class' => 'kt-form kt-form--label-right', 'errorCssClass' => 'has-danger'    ],
        'fieldConfig' => [
    ...
    <?php if ($model->isImage()) : ?>
        <div class="form-group<?= $strictThumb ? ' hidden' : '' ?> m-padding-b-15">
